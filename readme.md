...
👉 **[https://waste-type-detection-sprhkotwpyo4gcebfj67st.streamlit.app/](https://waste-type-detection-sprhkotwpyo4gcebfj67st.streamlit.app/)**
...
* **Organic / Inorganic Categorization**: Automatically maps detected object labels to their respective waste categories (*Organik* vs *Anorganik*) with distinct color-coded badges (Green for Organic, Red for Inorganic).
